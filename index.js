...
const uri = `mongodb+srv://${dbUsername}:${dbPassword}@cluster0.6fip419.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
async function run() {
  try {
    ...
    app.get("/all-books", async (req, res) => {
        ...
        if (req.query?.search) {
          query = { bookTitle: req.query.search }
      }
